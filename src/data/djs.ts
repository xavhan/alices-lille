...
export const InnerSense: DJ = {
    ...
    description: 'Passionné de musique et collectionneur de disques depuis 30 ans Inner Sense affectionne les sonorités House, Garage, Disco et Funky. Il a également produit plusieurs morceaux pour le label My Love Is Underground dont il est très proche.'
}
